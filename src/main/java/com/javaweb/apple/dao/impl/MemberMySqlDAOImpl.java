...
//		private static String SQL_MEMBER_CHEKCS_SEARCH_JOINDAY_PG = "select count(*) as searchCnt from members where join_day like concat('%',?,'%')"; 
	...
	public static String SQL_MEMBERS_CHEKC_SEARCH_ALL_PG = "SELECT count(*) as searchCnt FROM members "
	...
	public List<MemberVO> selectMembersByJoinDay(String joinDay, int offset, int limit) {
		return null;// this.jtem.query(SQL_SELECT_MEMBERS_BYJOINDAY, new Object[] { joinDay, offset,
					// limit },
		// BeanPropertyRowMapper.newInstance(MemberVO.class));
	}
	...
	public List<MemberVO> selectMembersByALL(String keyword, int offset, int limit) {
		return this.jtem.query(SQL_SELECT_MEMBERS_BYALL,
				new Object[] { keyword, keyword, keyword, keyword, offset, limit },
				BeanPropertyRowMapper.newInstance(MemberVO.class));
	...
	public int checkAllMembersCount(String keyword) {
		return jtem.queryForObject(SQL_MEMBERS_CHEKC_SEARCH_ALL_PG, Integer.class, keyword, keyword, keyword, keyword);
	}

	@Override
	public int checkNameMembersCount(String keyword) {
		return jtem.queryForObject(SQL_MEMBERS_CHEKC_SEARCH_NAME_PG, Integer.class, keyword);
	}

	@Override
	public int checkLoginMembersCount(String keyword) {
		return jtem.queryForObject(SQL_MEMBERS_CHEKC_SEARCH_LOGIN_PG, Integer.class, keyword);
	}

	@Override
	public int checkEmailMembersCount(String keyword) {
		return jtem.queryForObject(SQL_MEMBERS_CHEKC_SEARCH_EMAIL_PG, Integer.class, keyword);
	}

	@Override
	public int checkPhoneMembersCount(String keyword) {
		return jtem.queryForObject(SQL_MEMBERS_CHEKC_SEARCH_PHONE_PG, Integer.class, keyword);
	}
